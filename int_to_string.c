 ...
 * @i: Indicate integer to get absolute value of
 *
 ...
 * @num: Indicate number to get length needed for
 * @base: Indicate base of number representation used by buffer
 *
 ...
 * @num: Indicate number to convert to string given base
 * @base: Indicate base of number used in conversion, only works up to base 36
 * @buff: Indicate buffer to fill with result of conversion
 * @buff_size: Indicate size of buffer in bytes
 *
 * Return: always void.
 */
void fill_numbase_buff(unsigned int num, unsigned int base,
